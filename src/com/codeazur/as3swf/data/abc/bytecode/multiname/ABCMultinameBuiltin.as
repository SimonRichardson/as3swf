package com.codeazur.as3swf.data.abc.bytecode.multiname
{
	...
	public class ABCMultinameBuiltin {
		...
		public static const ARRAY:ABCQualifiedName = ABCQualifiedName.create(ARRAY_NAME, ABCNamespaceType.PUBLIC.ns);
		...
		public static const VECTOR:ABCQualifiedName = ABCQualifiedName.create(VECTOR_NAME, ABCNamespaceType.BUILTIN.ns);
		...
		private static const VECTOR_NAME:String = "Vector";
