package com.codeazur.as3swf.data.abc.exporters.js
{
	...
	public class ABCJavascriptExporter implements IABCExporter {
		...
		public static const NAMESPACE_PACKAGE_PREFIX:String = "";
		public static const NAMESPACE_PRIVATE_PREFIX:String = "_private_";
		public static const NAMESPACE_PROTECTED_PREFIX:String = "_protected_";
		...
		public function write(data:ByteArray) : void {
			...
			for(var i:uint=0; i<classInfoTotal; i++) {
				...
				for(var j:uint=0; j<methodTotal; j++) {
					...
					if(	!(StringUtils.isEmpty(methodInfo.label) || 
						  ABCNamespaceType.isTypeByValue(methodInfo.label, ABCNamespaceType.ASTERISK))) {
